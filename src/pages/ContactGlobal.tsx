      ...
      <section className="section-padding bg-black pt-32 contact_bg_new">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-12 justify-center items-center gap-12 form_contact">
            ...
            <div className="space-y-6 lg:col-span-6 justify-self-auto contact-about">
              <span className="contact_text_badge mx-auto">Contact Us</span>
              <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 text-center">
                Get In Touch
              </h1>
              <p className="text-xl lg:text-1xl text-white/90 leading-relaxed text-center mt-1">
              ...
              {/* <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 mb-3">
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className=" !border-none lg:col-span-6  p-0"
                    >
                      <CardContent className="p-6 px-3">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className=" ">
                      <Button
                        ...
                        className="btn-primary w-full md:w-full bg-[#a100ff] hover:bg-[#a100ff]"
                      >
                        <Send className="w-full h-5 mr-2" />
                        Send Message
                      </Button>
                    </div>
                  </form>
